        ...
        <div className="container">
          ...
          <div className={clsx(style["cart-content"])}>
            <header className={clsx(style["cart-content__header"])}>
              <div className="row">
                <div className="col-4">
                  <span className={clsx(style.product)}>Sản Phẩm</span>
                </div>
                <div className="col-2">
                  <span>Đơn Giá</span>
                </div>
            ...
            {cartList.map((item) => {
              return (
                <section
                  className={clsx(style["cart-content__section"])}
                  key={item._id}
                >
                  <div className={clsx(style["cart-content__section-brand"])}>
                    <h4>{item.brand}</h4>
                  </div>
                  <div className={clsx(style["cart-content__section-product"])}>
                    <div className="row">
                      <div className="col-4">
                        <div
                          className={clsx(
                            style["cart-content__section-product-title"]
                          )}
                        >
                          <div
                            className={clsx(
                              style["cart-content__section-product-img"]
                            )}
                          >
                            <Link
                              to={`/details/name~${removeAccents(item.name)}/${
                                item._id
                              }`}
                            >
                      ...
                      <div className="col-2">
                        <div
                          className={clsx(
                            style["cart-content__section-product-price"]
                          )}
                        >
                          <p
                            className={clsx(
                              style["cart-content__section-product-price-old"]
                            )}
                          >
                            {item.sale &&
                              formatCurrency(
                          ...
                          <p
                            className={clsx(
                              style["cart-content__section-product-price-new"]
                            )}
                          >
                      ...
                      <div className="col-2">
                        <div
                          className={clsx(
                            style["cart-content__section-product-quantity"]
                          )}
                        >
                          <div
                            className={clsx(
                          ...
                          >
                            <QuantityInput isPages="cart" data={item} />
                          </div>
                        </div>
                      </div>
                      <div className="col-2">
                        <div
                          className={clsx(
                            style["cart-content__section-product-price-total"]
                          )}
                        >
                          <span>
                      ...
                      <div className="col-2">
                        <div
                          className={clsx(
                            style["cart-content__section-product-delete"]
                          )}
                        >
                          <DeleteBtn data={item} />
                        </div>
